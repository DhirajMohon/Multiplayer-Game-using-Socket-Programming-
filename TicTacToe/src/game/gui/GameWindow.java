		...
		for (int x=0; x<3; x++) {
			for (int y=0; y<3; y++) {
				...
				if (field!=Game.NOBODY) {
					g2D.drawImage(Resources.letters[field-1], x*Game.FIELD_WIDTH, y*Game.FIELD_HEIGHT, Game.FIELD_WIDTH-5, Game.FIELD_HEIGHT-5, null);
				}
	...
	class Input extends MouseAdapter{
		...
		public void mousePressed(MouseEvent e) {
			if (e.getButton()==MouseEvent.BUTTON1) {
				game.inputRecived(e.getX()/Game.FIELD_WIDTH, e.getY()/Game.FIELD_HEIGHT);
			}
		}
	}
}